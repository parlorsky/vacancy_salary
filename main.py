...
if inp_species == 'медсестра':
    ...
    if flag == 0:
        ...
        a = json.load(open(f'{name}/model_0_code_experience_y_{name}.json'))
        prices = {i:a[i] for i in a if i not in base_skills_0}
    ...
    if vahta:
        if experience == 'Без опыта':
            ...
            flag = 0
            inputs = [model_0_code_experience_y_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_0_code_experience_y_sorted if x not in base_skills_0 ] if model_0_code_experience_y_sorted[i]!= 0 ]
            ...
            flag = 1
            inputs = [model_1_code_experience_y_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_1_code_experience_y_sorted if x not in base_skills_1 ] if model_1_code_experience_y_sorted[i]!= 0 ]
            ...
            flag = 2
            inputs = [model_2_code_experience_y_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_2_code_experience_y_sorted if x not in base_skills_2] if model_2_code_experience_y_sorted[i]!= 0 ]
        ...
        if experience == 'Без опыта':
            ...
            inputs = [model_0_code_experience_n_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_0_code_experience_n_sorted if x not in base_skills_0 ] if model_0_code_experience_n_sorted[i]!= 0 ]
            ...
            inputs = [model_1_code_experience_n_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_1_code_experience_n_sorted if x not in base_skills_1 ] if model_1_code_experience_n_sorted[i]!= 0 ]
            ...
            inputs = [model_2_code_experience_n_sorted[i] if st.checkbox(i) else 0 for \
                 i in [x for x in model_2_code_experience_n_sorted if x not in base_skills_2] if model_2_code_experience_n_sorted[i]!= 0 ]
    ...
    if flag == 3:
        ...
        a = json.load(open(f'{name}/model_0_code_experience_n_{name}.json'))
        prices = {i:a[i] for i in a if i not in base_skills_0}
        dfx = pd.DataFrame([int(x) for x in prices.values()],index = [x for x  in prices.keys()],columns = ['Стоимость навыка'])
        fig = px.histogram(dfx,x = dfx['Стоимость навыка'],y = dfx.index,  width=1000, height=1000,labels={'x':'Стоимость навыка', 'y':'Навык'})
        st.plotly_chart(fig, use_container_width=False)
    ...
    if flag == 4:
        ...
        a = json.load(open(f'{name}/model_1_code_experience_n_{name}.json'))
        prices = {i:a[i] for i in a if i not in base_skills_1}
        dfx = pd.DataFrame([int(x) for x in prices.values()],index = [x for x  in prices.keys()],columns = ['Стоимость навыка'])
        fig = px.histogram(dfx,x = dfx['Стоимость навыка'],y = dfx.index,  width=1000, height=1000,labels={'x':'Стоимость навыка', 'y':'Навык'})
        st.plotly_chart(fig, use_container_width=False)
    ...
    if flag == 5:
        ...
        a = json.load(open(f'{name}/model_2_code_experience_n_{name}.json'))
        prices = {i:a[i] for i in a if i not in base_skills_2}
        dfx = pd.DataFrame([int(x) for x in prices.values()],index = [x for x  in prices.keys()],columns = ['Стоимость навыка'])
        fig = px.histogram(dfx,x = dfx['Стоимость навыка'],y = dfx.index,  width=1000, height=1000,labels={'x':'Стоимость навыка', 'y':'Навык'})
        st.plotly_chart(fig, use_container_width=False)
    ...
    if flag == 4:
        ...
        prices ={i:a[i] for i in json.load(open(f'{name}/model_1_code_experience_n_{name}.json')) if i not in base_skills_1}
        dfx = pd.DataFrame([int(x) for x in prices.values()],index = [x for x  in prices.keys()],columns = ['Стоимость навыка'])
        fig = px.histogram(dfx,x = dfx['Стоимость навыка'],y = dfx.index,  width=1000, height=1000,labels={'x':'Стоимость навыка', 'y':'Навык'})
        st.plotly_chart(fig, use_container_width=False)
        st.write("обязательно разверните график, нажав на значок стрелок, чтобы ознакомиться с информацией")
    ...
    if flag == 0:
        ...
        prices = {i:a[i] for i in a if i not in base_skills_0}
        dfx = pd.DataFrame([int(x) for x in prices.values()],index = [x for x  in prices.keys()],columns = ['Стоимость навыка'])
        fig = px.histogram(dfx,x = dfx['Стоимость навыка'],y = dfx.index,  width=2000, height=6000,labels={'x':'Стоимость навыка', 'y':'Навык'})
        st.plotly_chart(fig, use_container_width=False)
        st.write("обязательно разверните график, нажав на значок стрелок, чтобы ознакомиться с информацией")
        fig1 = px.pie(dfx,values = dfx['Стоимость навыка'],names = dfx.index,  width=5000, height=5000,title = 'Отношение стоимости признаков')
        st.plotly_chart(fig1, use_container_width=False)
